...
- **Node 8 LTS:** `cz-github` has a minimum Node version
...
``` bash
git clone https://github.com/EndemolShineGroup/cz-github.git
cd cz-github
yarn
yarn test
```
...
We want to ensure that `cz-github` is secure for everyone. If
